...
import {DatabaseClientInterface} from '../common/db-client/database-client.interface.js';
...
export default class Application {
  ...
  public async init() {
    ...
    await this._initDb();
    this.logger.info('database rdy');

    await this._initMiddleware();
    this.logger.info('Middlewares rdy');

    await this._initRoutes();
    this.logger.info('Routes rdy');

    await this._initExceptionFilters();
    this.logger.info('Exception filters rdy');
